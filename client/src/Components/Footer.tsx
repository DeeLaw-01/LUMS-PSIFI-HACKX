        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-12">
          ...
          <div className="flex flex-col space-y-4">
            ...
            <p className="text-sm text-slate-400">
              We are a cutting-edge startup platform that connects like-minded individuals and accelerates innovation.
            </p>
          </div>
          ...
          <div className="flex flex-col space-y-4">
            ...
            <p className="text-slate-400">Email: <a href="mailto:info@company.com" className="hover:text-blue-400">info@company.com</a></p>
            <p className="text-slate-400">Phone: <a href="tel:+1234567890" className="hover:text-blue-400">+1 234 567 890</a></p>
          </div>
